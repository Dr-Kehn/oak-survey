const BuildingConfident = () => {
  return (
    <section className="w-full bg-white">
      <div className="max-w-[1440px] w-[90%] sm:w-[85%] lg:w-[90%] mx-auto flex flex-col lg:flex-row gap-8 sm:gap-10 justify-center py-10 sm:py-16 lg:py-20 text-gray-text px-4 sm:px-0">
        {/* Left Section */}
