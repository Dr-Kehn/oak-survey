export default function HeroSection() {
  return (
    <section className="relative bg-[linear-gradient(rgba(31,31,31,0.8),rgba(31,31,31,0.8)),url('/newHomeImage')] w-full min-h-[400px] sm:min-h-[500px] lg:min-h-[559px] bg-cover bg-no-repeat bg-center">
      <div className="min-h-[188px] pt-[210px] sm:pt-[260px] lg:pt-[302px] w-[90%] sm:w-[85%] lg:w-[90%] mx-auto pb-7 px-4 sm:px-0">
        ...
        <p className="leading-relaxed sm:leading-8 lg:leading-9 font-bold text-[0.75rem] sm:text-[0.95rem] lg:text-[1.125rem] w-full lg:text-left text-center mt-6 sm:mt-8 lg:mt-10 lg:w-[90%] text-white-accent">
